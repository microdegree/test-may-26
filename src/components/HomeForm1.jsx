...
function HomeSection7() {
  ...
  return (
      ...
      <p className='text-sm text-white'>You will soon receive your free ebook on your email id. For re-submitting <span className='text-yellow-500 cursor-pointer ' onClick={()=>setFormAlert(!formAlert)}><a href="https://www.microdegree.work/">Click here</a></span> </p>
    </div>
