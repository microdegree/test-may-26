...
function Courses() {
    ...
    const Courses = [
        ...
        },
        {
          ...
          "course_category":'Networking',
          "course_name":'Network certifications(CCNA)',
          "course_price":'Coming Soon',
          "course_desc":"Widely regarded as a staple network certification, the Cisco Certified Network Associate (CCNA) is an associate-level (early career) credential. It covers a wide range of networking fundamentals.",
...
<div className="h-full w-full p-4 space-y-3" >
  ...
  <div className="w-full h-full  space-y-8" id="courses">
